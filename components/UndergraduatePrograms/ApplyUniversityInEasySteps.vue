...
import icon1 from "~/assets/img/svgs/apply1.svg";
import icon2 from "~/assets/img/svgs/apply2.svg";
import icon3 from "~/assets/img/svgs/apply3.svg";

export default defineComponent({
  name: "ApplyUniversityInEasySteps",
  data() {
    return {
      applyItems: [
        {
