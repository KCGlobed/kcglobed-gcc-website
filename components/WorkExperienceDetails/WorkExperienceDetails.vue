        ...
        <form @submit.prevent>
          ...
          <div class="mb-4">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="employmentStatus" id="fresher" value="Fresher"
                v-model="status">
            ...
            <div v-for="(job, index) in formData.work_experience" :key="index"
              ...
              <div class="row">
                ...
                <div class="col-md-12 mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Years / Months" v-model="job.duration"
