...
.domain-card.blue {
    ...
    /* Navy mapping to blue class */
}

.domain-card.magenta {
    background-color: #ba1b94;
}
...
.learning-platform h5 {
    ...
    margin: 0;
    color: #fff;
    /* Adjusted to be visible on grayish bg if needed, but in image it looks white/light */
