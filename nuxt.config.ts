...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    razorpayAmount: process.env.RAZORPAY_PAYMENT_AMOUNT || '1250',
    paymentAmount: process.env.PAYMENT_AMOUNT || '1250',
    // ── Cashfree ──────────────────────────────────────────────────────────────
    ...
    cashfreePaymentAmount: process.env.CASHFREE_PAYMENT_AMOUNT || '1250',
